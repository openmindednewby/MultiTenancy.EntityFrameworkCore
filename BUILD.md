# Building and Deploying MultiTenancy.EntityFrameworkCore
...
```bash
git clone https://github.com/yourusername/MultiTenancy.EntityFrameworkCore.git
cd MultiTenancy.EntityFrameworkCore
```
...
dotnet add package MultiTenancy.EntityFrameworkCore --version 1.0.0 --source LocalFeed
```
...
2. Click **Create**
3. Provide a key name (e.g., "MultiTenancy.EntityFrameworkCore")
4. Select **Push** scope
5. Select packages or glob pattern (e.g., `MultiTenancy.EntityFrameworkCore*`)
...
https://www.nuget.org/packages/MultiTenancy.EntityFrameworkCore
...
- 📦 **NuGet**: [NuGet Package Page](https://www.nuget.org/packages/MultiTenancy.EntityFrameworkCore)
